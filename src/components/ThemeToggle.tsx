...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="p-2 rounded-full glass-panel flex items-center justify-center transition-all duration-300 opacity-50 cursor-not-allowed border-white/10 active:scale-95"
